...
public:
     ...
     */
    explicit Param(System& system,bool use_extended=false,uint8_t target_component_id=1); // deprecated
     ...
     * @param system The specific system associated with this plugin.
     */
    explicit Param(std::shared_ptr<System> system,bool use_extended=false,uint8_t target_component_id=1); // new
